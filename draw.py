    ...
    for lat in range(lat_start, lat_stop + 1):
        for longt in range(longt_start, longt_stop+1):
            ...
            if (index % steps != steps - 1):
                p0 = [points[index][0], points[index][1], points[index][2]]
                p1 = [points[index + steps + 1][0], points[index + steps + 1][1], points[index + steps + 1][2]]
                p2 = [points[index + steps ][0], points[index + steps][1], points[index + steps][2]]
                add_polygon(polygons, p0[0], p0[1], p0[2], p1[0], p1[1], p1[2], p2[0], p2[1], p2[2])
                if (index % steps != steps - 1 and index % steps != 0):
                    p0_1 = [points[index][0], points[index][1], points[index][2]]
                    p1_1 = [points[index + 1][0], points[index + 1][1], points[index + 1][2]]
                    p2_1 = [points[index + 1 + steps][0], points[index + 1 + steps][1], points[index + 1 + steps][2]]
                    add_polygon(polygons, p0_1[0], p0_1[1], p0_1[2], p1_1[0], p1_1[1], p1_1[2], p2_1[0], p2_1[1], p2_1[2])
